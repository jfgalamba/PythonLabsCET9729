...
acompanhamento = input("Tipo de acompanhamento: ")

convite = f"""
{INDENT_SAUDACAO * ' '}Caro {nome}
{INDENT_PARAGRAFO * ' '}Venho por este meio convidá-lo/la para a cerimónia a realizar pelas {hora} do dia
{data}. Caro {nome}, o código de vestimento é formal, o que significa que
deverá usar um fato com gravata/vestido e saltos altos.
{INDENT_PARAGRAFO * ' '}O dia {data} é uma data muito especial para mim e contamos com a sua presença. O
convite é extensível à sua {acompanhamento}.
