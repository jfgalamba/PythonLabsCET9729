...
v3: desaparece opção terminar, pergunta se pretende mais conversões
    (versão com variável booleana)
"""
...
def main():
    ...
    repetir_conversoes = True
    while repetir_conversoes:
